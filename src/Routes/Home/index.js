      ...
      <div className={styles.home}>
        ...
        <div className={[styles.titles, "center"].join(" ")}>
          ...
          <span>
            ...
            GOtv & Startimes), Electricity Bill Payment and so much more.
          </span>
        </div>
        <div className={styles.cards}>
          <Card
          ...
          <Card
            styles="card30"
            info="Making online recharge cheap and easy to buy at all time of the day TopUpLab Telecom Services"
            src={logo5}
        ...
        <div className={styles.cards}>
          ...
          <Card
            styles="card30"
            info="Send BulkSMS to any number for as low as just 2.5kobo per unit."
            src={logo9}
            title="Bulk Sms"
            anim="fade-up"
            delay="2050"
        ...
        <div className={[styles.titles, "center"].join(" ")}>
          ...
          <span>
            Subscribe for cheap data plans at affordable price for all network
          </span>
        </div>
        ...
        <FlexSection
          ...
          info="With our ready-to-use and developer friendly API, you can easily integrate with your website or app for FREE to start receiving payments in a breeze."
        ><button>API Documention</button></FlexSection>
